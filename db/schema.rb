...
ActiveRecord::Schema.define(version: 2021_04_07_163548) do
  ...
  create_table "sidecar_image_transitions", charset: "latin1", force: :cascade do |t|
  ...
  create_table "solr_document_sidecars", charset: "latin1", force: :cascade do |t|
    t.string "document_id"
    t.string "document_type"
    t.string "image"
    t.bigint "version"
